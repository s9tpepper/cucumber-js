var HtmlTemplate = function () {
  ...
  var self = {
    addFeature: function addFeature(keyword, name, description, tags) {
    ...
    addStepResult: function addStepResult(keyword, name, step, stepResult) {
      var stepHasAttachment = step.hasAttachment();
      var attachment;
      if (stepHasAttachment) {
        attachment = step.getAttachmentContents();
      } else {
        attachment = "";
      }
    ...
    saveReport: function saveReport(file, logs) {
      var summaryElement = document.getElementById("summary");
      summaryElement.innerHTML = logs;
